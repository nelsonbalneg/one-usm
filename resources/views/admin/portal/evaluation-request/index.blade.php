...
@push('scripts')
    ...
    <script>
        ...
        function loadData() {
            ...
            var table = $('#dbData').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.portal.evaluation-requests.get-all-data') }}",
                    type: "GET",
                    dataType: "JSON",
                    complete: function() {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.addEventListener('click', event => {
                ...
                if (editButton) {
                    ...
                    const editUrl = `/admin/portal/evaluation-requests/${id}/edit`;
        ...
        $('#editForm').submit(function(event) {
            ...
            $.ajax({
                url: '/admin/portal/evaluation-requests/' + evaluation_request,
                method: 'PUT',
                data: formData,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
