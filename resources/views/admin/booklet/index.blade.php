...
@push('scripts')
    ...
    <script>
        ...
        addBookletForm.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch("{{ route('admin.cee.booklet.store') }}", {
                    method: 'POST',
                    body: formData,
                    headers: {
    ...
    <script>
        ...
        function loadData() {
            ...
            var table = $('#dbData').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.cee.booklet.fetch-data') }}",
                    type: "GET",
                    dataType: "JSON"
                },
                columns: [{
        ...
        $('#editForm').submit(function(event) {
            ...
            $.ajax({
                url: '/admin/cee/booklet/' + bookletid, // Replace with your endpoint URL
