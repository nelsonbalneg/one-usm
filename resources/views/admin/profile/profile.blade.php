...
@section('contents')
    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
        <div class="grow">
            <h5 class="text-16">USMCEE Detailed Information of {{ $studentdetails->firstname }}
                {{ $studentdetails->middlename }}
                {{ $studentdetails->lastname }} {{ $studentdetails->ssuffix }} </h5>
        </div>
        ...
        <div class="xl:col-span-12">
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-12 2xl:grid-cols-12">
                        ...
                        <form id="profile-form"
                            action="{{ route('admin.cee.update-photo', ['id' => $studentdetails->id]) }}" method="POST"
                            ...
                            <div class="lg:col-span-2 2xl:col-span-1">
                                <div
                                    ...
                                    @else
                                        <img src="http://172.16.0.43/uploads/{{ basename($studentdetails->photo) }}"
                                            alt="no ing"
                                            class="object-cover w-full h-full rounded-full user-profile-image">
                                    @endif
                                    <div
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="addDataSite" action="{{ route('admin.cee.update-profile', ['id' => $studentdetails->id]) }}"
...
@push('scripts')
    ...
    <script>
        ...
        async function fetchSchoolData(schoolid) {
            ...
            const schoolListUrl = "{{ route('admin.school_list.index') }}";
            const url = schoolid ?
        ...
        $(document).ready(function() {
            ...
            $('form').on('submit', function(event) {
                ...
                const formAction = form.action; // Form action URL
                const formMethod = form.method; // Form method (e.g., POST or PUT)
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // If confirmed, submit the form via Fetch API
                        fetch(formAction, {
                                method: formMethod,
                                headers: {
                            ...
                            .then(data => {
                                // Check response and show appropriate SweetAlert message
