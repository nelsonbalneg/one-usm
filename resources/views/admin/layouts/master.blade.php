...
<html lang="en" class="light scroll-smooth group" data-layout="vertical" data-sidebar="dark" data-sidebar-size="lg"
    data-mode="light" data-topbar="dark" data-skin="default" data-navbar="sticky" data-content="fluid" dir="ltr">
...
<head>
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"
        integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5/0x6Gf/2x3B0iHsOTs0jIlQ/tfZ6C4SLN6SA4Fe" crossorigin="anonymous">
    </script>
...
<body
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-2 product">
                            <div
                                ...
                                <img src="{{ asset('backend/assets/images/img-012.png') }}" alt=""
                                    class="h-8">
                            </div>
                        ...
                        <div class="flex gap-2 product">
                            <div
                                class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                                <img src="{{ asset('backend/assets/images/img-03.png') }}" alt=""
                                    class="h-8">
                            </div>
                            <div class="overflow-hidden grow">
                                <div class="ltr:float-right rtl:float-left">
    ...
    <script src="{{ asset('backend/assets/lucide/lucide.min.js') }}"></script>
