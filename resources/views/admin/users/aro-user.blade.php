...
@section('contents')
            ...
            <div class="card" id="usersTable">
                <div class="card-body">
                    <div class="flex items-center">
                        <h6 class="uppercase text-15 grow">Admission and Recods Office Users</h6>
                        <div class="shrink-0">
                ...
                <div class="p-4">
                    <form id="addUserForm" method="POST">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p><i data-lucide="check" class="inline-block size-4 mt-0.5 shrink-0"></i>The Default
                                    password is the phone number registered.</p>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <!-- Employee ID-->
                            <div>
                                <label for="addEmployeeId" class="block mb-2 text-base font-medium">Employee ID</label>
                                <input type="text" id="addEmployeeId" name="employee_id" placeholder="Enter Employee ID"
                                    class="form-input" value="{{ old('employee_id') }}">
                            </div>
                            ...
                            <!-- Sex -->
                            <div>
                                <label for="addSex" class="block mb-2 text-base font-medium">Sex</label>
                                <select id="addSex" name="sex" class="form-input">
                                    <option value="">--Select--</option>
                            ...
                            <!-- Phone Number -->
                            <div>
                                <label for="addPhone" class="block mb-2 text-base font-medium">Phone Number</label>
                                <input type="text" id="addPhone" name="phone" placeholder="Enter phone number"
                            ...
                            <div>
                                ...
                                <select id="addRole" name="role" class="form-input">
                                    ...
                                    <option value="aro" selected>Aro</option>
                ...
                <div class="p-4">
                    <form id="editForm">
                        ...
                        <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-12">
                                <label for="lrn" class="inline-block mb-2 text-base font-medium">LRN</label>
                                <input type="text" id="lrn" name="lrn"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    placeholder="LRN" value="{{ old('lrn') }}" onblur="validateLRN()">
                            </div>
                            ...
                            <div class="xl:col-span-12">
                                <label for="middlename" class="inline-block mb-2 text-base font-medium">Middle
                                    Name</label>
                                <input type="text" id="middlename1" name="middlename"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            ...
                            <div class="xl:col-span-12">
                                <label for="sex" class="inline-block mb-2 text-base font-medium">Sex</label>
                                <select
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    name="sex" id="sex">
                                    <option value="">--Select--</option>
                            ...
                            <div class="xl:col-span-12">
                                <label for="birthdate" class="inline-block mb-2 text-base font-medium">Birthdate</label>
                            ...
                            <!-- Employee ID-->
                            <div class="xl:col-span-12">
                                <label for="employee_id" class="block mb-2 text-base font-medium">Employee ID</label>
                                <input type="text" id="employee_id1" name="employee_id"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
    ...
    {{-- end drawer --}}
     ...
     <!-- add Modal Structure -->
    <div id="addModal" modal-top class="fixed inset-0 z-50 flex items-center justify-center hidden">
        ...
        <div class="relative w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zinc-600 z-10">
            <div class="flex items-center justify-between p-4 border-b dark:border-zinc-500">
                <h5 class="text-16" id="userFullNameDisplay"></h5>
                <button id="closeModalButton"
                    class="transition-all duration-200 ease-linear text-slate-400 hover:text-red-500">
                    <i data-lucide="x" class="size-5"></i>
                </button>
            ...
            <div class="p-4">
                <form id="addForm">
                    @csrf
                    <input type="hidden" name="user_assigned_id" id="user_assigned_id">
                    <div id="alert-error-msg"
                        class="hidden px-4 py-3 text-sm text-red-500 border border-transparent rounded-md bg-red-50 dark:bg-red-500/20">
                    </div>
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <label for="inputPlaceholder" class="inline-block mb-2 text-base font-medium">Program</label>
                            <select class="form-input" id="choices-multiple-default" data-choices
                                name="choices-multiple-default[]" multiple>
                                @foreach ($programs as $program)
                                    <option value="{{ $program['id'] }}"
                                        @if (in_array($program['id'], $selectedPrograms)) selected @endif>
                                        {{ $program['realCampus'] }} - {{ $program['programName'] }}
...
@push('scripts')
    ...
    <script>
        ...
        document.getElementById('addForm').addEventListener('submit', function(e) {
            ...
            fetch("{{ route('admin.user.assign-programs') }}", {
                    method: "POST",
                    headers: {
                ...
                .catch(async err => {
                    ...
                    document.getElementById('alert-error-msg').classList.remove('hidden');
    ...
    <script>
        ...
        function loadData() {
            ...
            var table = $('#dbData').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.user.get-all-aro.show') }}",
                    type: "GET",
                    dataType: "JSON",
                    complete: function() {
        ...
        $('body').on('click', '#openModalButton', function(event) {
            ...
            $('#user_assigned_id').val(userId);
            $('#userFullNameDisplay').text(fullname);

            // OPTIONAL: Fetch the modal content with the correct programs based on the user
            $.get('/admin/users/programs/' + userId, function(response) {
                $('#programModalContent').html(
                    response); // Load the returned view into your modal container
        ...
        $('body').on('click', '#openModalButton', function(event) {
            event.preventDefault();
            $('#addUserModal').removeClass('hidden'); // Open modal
        });
        ...
        $('#addUserForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.user.add-new-user') }}",
        ...
        $('#editForm').submit(function(event) {
            ...
            $.ajax({
                url: '/admin/user/' + userid, // Replace with your endpoint URL
                method: 'POST', // Use POST method
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.addEventListener('click', event => {
                ...
                if (editButton) {
                    ...
                    const editUrl = `/admin/user/${id}/edit`;
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.user) {
                                ...
                                $('#employee_id1').val(user.employee_id);
    ...
    <script>
        ...
        $('body').on('click', '.change-pass', function(event) {
            ...
            let id = $(this).data('id');
            let editUrl = '/admin/user/change-password/' + id + '/edit';
        ...
        $('#changepassForm').submit(function(event) {
            ...
            // AJAX PUT request for updating data
            $.ajax({
                url: '/admin/user/update-password/' + userid, // Replace with your endpoint URL
                method: 'POST', // Use POST method
                data: formData, // Send _method=PUT parameter
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
