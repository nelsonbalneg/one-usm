...
<body
        ...
        <div class="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                ...
                <div class="mt-8 text-center">
                    {{-- <h4 class="mb-1 text-yellow-500 dark:text-yellow-500">Welcome to CEE-ADMINISTRATION</h4> --}}
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-10">
                    ...
                    {{-- <div class="mt-5 g-recaptcha" data-sitekey="{{ config('services.recaptcha.site') }}"></div> --}}
                    {{-- <div class="mt-5 cf-turnstile" data-sitekey="{{ config('services.turnstile.sitekey') }}"></div> --}}
                    <div class="mt-5 text-center">
                        <button type="submit" id="signInBtn" onclick="handleSignInClick(event)"
                            class="flex items-center justify-center w-full gap-2 text-white bg-green-500 border-green-500 btn hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/10">

                            <!-- Icon with vertical alignment -->
                            <span id="btnIcon" class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 stroke-[2]" fill="none"
    ...
    <script>
        function handleSignInClick(event) {
            event.preventDefault(); // Stop default form submission temporarily
