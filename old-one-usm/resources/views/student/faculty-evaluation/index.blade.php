...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    <div class="grow">
        <h5 class="uppercase text-16 font-semibold text-green-600">FACULTY EVALUATION</h5>
    </div>
            ...
            <div class="card-body flex flex-col md:flex-row items-center gap-6 p-6">
                ...
                <div class="flex-1">
                    ...
                    <p class="mb-4 text-slate-500 dark:text-zinc-200">
                        Your feedback plays a vital role in improving the quality of teaching at USM. 
                        Kindly accomplish the faculty evaluation form for your enrolled instructors.
                        Your responses will remain confidential and will be used solely for faculty development.
                    </p>

                    <a href="{{ route('student.student.faculty-evaluation.connect') }}" 
                       class="inline-block px-4 py-2 bg-green-500 text-white font-medium rounded hover:bg-green-600 transition" 
                       target="_blank">
                        Connect to Faculty Evaluation
                    </a>
                </div>
