        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <a href="#">
                        <span class="hidden">
                            <img src="{{ asset('backend/assets/images/avatar-2.png') }}"
                                alt="" class="h-6 mx-auto">
                        </span>
                        <span class="group-data-[topbar=dark]:hidden group-data-[topbar=brand]:hidden">
                            <img src="{{ asset('backend/assets/images/avatar-2.png') }}" alt=""
                                class="h-6 mx-auto">
                        </span>
                    </a>
                ...
                <div class="flex gap-3 ms-auto">
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        ...
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600"
                            ...
                            <h6 class="mb-2 text-sm font-normal text-slate-500 dark:text-zink-300">Welcome to ONE USM
                            </h6>
                            <a href="#!" class="flex gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="uppercase text-slate-500 dark:text-zink-300"> {{ Auth::user()->role }}</p>
                                </div>
                            </a>
                            <ul>
