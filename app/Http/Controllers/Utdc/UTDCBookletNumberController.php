...
class UTDCBookletNumberController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('utdc.booklet.index', compact('ceeActiveSession'));
    }
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return '<div class="flex gap-3">
                                ...
                                <a href=' . route('utdc.cee.booklet.delete', $row->id) . ' class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md delete-entry size-8 bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"><i data-lucide="trash-2" class="size-4"></i></a>
                            </div>';
                })
