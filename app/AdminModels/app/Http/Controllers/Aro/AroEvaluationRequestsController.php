...
class AroEvaluationRequestsController extends Controller
{
    /**
    ...
    {
        return view('aro.evaluation-request.index');
    }
            ...
            return datatables()->of($data)
                ...
                ->addColumn('action', function ($row) {
                    return ' <div class="flex gap-2">
                                ...
                                <a href=' . route('aro.portal.evaluation-requests.destroy', ['evaluation_request' => $row->id]) . ' class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 delete-entry bg-slate-100 text-slate-500 hover:text-red-500 hover:bg-red-100 dark:bg-red-600 dark:text-red-200 dark:hover:bg-red-500/20 dark:hover:text-red-500"><i data-lucide="trash-2" class="size-4"></i></a>
                                </div>';
                })
