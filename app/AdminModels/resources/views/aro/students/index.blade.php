...
@section('title')
    USM-AES | Pre-registration - Students
@endsection
                        ...
                        <div class="space-y-4 xl:col-span-12">
                            ...
                            @foreach ($requirements as $id => $label)
                                <div class="flex items-center justify-between">
                                    <h4 class="text-sm font-medium text-slate-700 dark:text-slate-200">{{ $label }}
                                    </h4>
                                    <div class="shrink-0">
                                        <div
                                            class="relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2">
                                            <input type="checkbox" nname="{{ $id }}" id="{{ $id }}"
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function initializeDataTable() {
                return $('#dataTable').DataTable({
                    ...
                    responsive: true,
                    ajax: {
                        url: '{{ route('aro.student.confirmed.data') }}',
                        type: 'GET'
                    },
                    columns: [{
                            data: 'actions',
            ...
            function cancelConfirmation(id, reason) {
                fetch(`{{ route('aro.student.cancel-confirmation.update', ['id' => '__ID__']) }}`.replace('__ID__',
                        id), {
                        method: 'PATCH',
                        headers: {
            ...
            $('body').on('click', '#openModalButton', function(event) {
                ...
                const url = `{{ route('aro.students.requirements.getRequirements', ['id' => '__ID__']) }}`
                ...
                fetch(url)
                    ...
                    .then(data => {
                        if (data) {
                            ...
                            document.getElementById('affidavit').checked = data.affidavit == 1;
                        }
                    });
            });
            ...
            document.getElementById('addForm').addEventListener('submit', function(e) {
                ...
                const url = `{{ route('aro.students.requirements.save') }}`;
                ...
                const data = {
                    ...
                    affidavit: document.getElementById('affidavit').checked,
                };
            ...
            $('body').on('click', '.addnstpPreference', function(event) {
                ...
                let id = $(this).data('id');
                let editUrl = '/aro/pre-registration/student-profile/' + id + '/edit';
            ...
            $('#saveNstpPref').on('click', function(e) {
                ...
                $.ajax({
                    url: `/aro/pre-registration/student-profile/update/${id}`,
                    type: 'PUT',
                    data: {
