...
@section('title')
    USM-CEE | UTDC - Result Templates
@endsection

@push('styles')
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css">s
@endpush
    ...
    <script>
        ...
        function loadData() {
            ...
            var table = $('#dbData').DataTable({
                ...
                ajax: {
                    url: "{{ route('utdc.cee.result-template.get-data') }}",
                    type: "GET",
                    dataType: "JSON",
                },
                columns: [{
