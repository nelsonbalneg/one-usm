        ...
        <div class="xl:col-span-12">
            ...
            <div class="card">
                ...
                <div class="border-dashed card-body border-y border-slate-200 dark:border-zink-500">
                    ...
                    <form action="{{ route('utdc.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
            ...
            <div class="card">
                ...
                <div class="border-dashed card-body border-y border-slate-200 dark:border-zink-500">
                    ...
                    <form action="{{ route('utdc.password.update', $user->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                            <div class="xl:col-span-12">
