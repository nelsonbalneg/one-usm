<!DOCTYPE html>
<html lang="en" class="light scroll-smooth group" data-layout="horizontal" data-sidebar="light" data-sidebar-size="lg" data-mode="light" data-topbar="dark" data-skin="default" data-navbar="sticky" data-content="fluid" dir="ltr">
<head>
...
<body
    ...
    <div class="group-data-[sidebar-size=sm]:min-h-sm group-data-[sidebar-size=sm]:relative">
        ...
        @include('dean.layouts.sidebar')

        <!-- Left Sidebar End -->
        <div id="sidebar-overlay" class="absolute inset-0 z-[1002] bg-slate-500/30 hidden"></div>

        @include('dean.layouts.navbar')
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-2 product">
                            <div
                                ...
                                <img src="{{asset('backend/assets/images/img-012.png')}}" alt="" class="h-8">
                            </div>
                        ...
                        <div class="flex gap-2 product">
                            <div
                                class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                                <img src="{{asset('backend/assets/images/img-03.png')}}" alt="" class="h-8">
                            </div>
                            <div class="overflow-hidden grow">
                                <div class="ltr:float-right rtl:float-left">
                                    <button
    ...
    <div id="customizerButton" drawer-end
     ...
     <!-- Add jQuery (Include before other JS files) -->
