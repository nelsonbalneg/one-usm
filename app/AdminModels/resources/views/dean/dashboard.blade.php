@extends('dean.layouts.master')
@section('title')
     USM-AES |Dean Dashboard
@endsection
        ...
        <div class="grow">
            <h5 class="text-16">
                @if ($selectedPrograms->isNotEmpty())
                    <h5 class="text-16">ADMISSION MONITORING</h5>
                    <span
    ...
    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-12">
        <div class="xl:col-span-12 md:col-span-12">
            <div class="card sticky top-[calc(theme('spacing.header')_*_1.3)]">
                <div class="card-body">
                    <h6 class="mb-0 text-lg font-semibold text-blue-500 uppercase">PROGRAMS UNDER
                    ...
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            ...
                            <tr class="font-semibold bg-slate-200 text-slate-700">
                                <td class="px-4 py-2 text-center border" colspan="2">Overall Total</td>
